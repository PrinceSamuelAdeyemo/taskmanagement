...
class Task(models.Model):
    personalTaskowner = models.ForeignKey(Profile, on_delete=models.CASCADE, null=True)
    businessTaskowner = models.ForeignKey(BusinessProfile, on_delete=models.CASCADE, null=True)
